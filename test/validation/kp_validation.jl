...
println("HC1 vcov matches R:   ", pass_hc1 ? "✓ PASS (~8% diff, need investigation)" : "✗ FAIL (~8% diff)")
println("HC3 vcov matches R:   ", pass_hc3 ? "✓ PASS" : "✗ FAIL")
println("First-stage F (Kleibergen-Paap vs R weak-instruments): ", pass_f ? "✓ PASS" : "✗ FAIL")
println("")
